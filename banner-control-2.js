var websitePrivacyPage = "https://www.mh-orthopaedie.de/";
...
var categoryDescriptionsText = {
	Necessary: {
		description: "Notwendige Cookies machen die Website nutzbar, indem sie Grundfunktionen wie Seitennavigation und Zugriff auf sichere Bereiche der Website ermöglichen. Ohne diese Cookies kann die Website nicht ordnungsgemäß funktionieren.",
	},
	Preferences: {
		description: "Präferenzcookies ermöglichen es einer Website, sich Informationen zu merken, die das Verhalten oder Aussehen der Website ändern.",
	},
	Statistics: {
	...
	Marketing: {
		description: "Marketing-Cookies werden verwendet, um Besucher über Websites hinweg zu verfolgen. Ziel ist es, Anzeigen anzuzeigen, die für den einzelnen Nutzer relevant und ansprechend sind.",
	},
	Unclassified: {
		description: "Nicht klassifizierte Cookies sind Cookies, die wir derzeit gemeinsam mit den Anbietern einzelner Cookies klassifizieren.",
	},
};
...
var websiteLogo = "https://www.mh-orthopaedie.de/wp-content/uploads/2020/01/logo_mhorthop%C3%A4die_4c_f.gif";
